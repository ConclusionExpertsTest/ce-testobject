...
public class CeUsersTest {
    ...
    public void CrudActions() throws JsonProcessingException {
        ...
        // Act - POST
        Response postResponse1 = CeUsersEndpoints.postNewCeUser(objectMapper.writeValueAsString(users1));
        Response postResponse2 = CeUsersEndpoints.postNewCeUser(objectMapper.writeValueAsString(users2));
        Response postResponse3 = CeUsersEndpoints.postNewCeUser(objectMapper.writeValueAsString(users3));
        ...
        // Act - PUT & GET (by id)
        Response putResponse = CeUsersEndpoints.putCeUser("1", objectMapper.writeValueAsString(updatedUsers1));
